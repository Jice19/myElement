...
// node_modules/.pnpm/rollup@4.41.0/node_modules/rollup/dist/es/shared/node-entry.js
...
var AssignmentExpression = class extends NodeBase {
  hasEffects(context) {
    ...
    if (!deoptimized)
      this.applyDeoptimizations();
    return right.hasEffects(context) || left.hasEffectsAsAssignmentTarget(context, operator !== "=") || ((_b = (_a = this.left).hasEffectsWhenDestructuring) == null ? void 0 : _b.call(_a, context, EMPTY_PATH, right));
  }
  hasEffectsOnInteractionAtPath(path, interaction, context) {
  ...
  include(context, includeChildrenRecursively) {
    ...
    if (includeChildrenRecursively || operator !== "=" || left.included || left.hasEffectsAsAssignmentTarget(hasEffectsContext, false) || ((_a = left.hasEffectsWhenDestructuring) == null ? void 0 : _a.call(left, hasEffectsContext, EMPTY_PATH, right))) {
...
var ImportExpression2 = class extends NodeBase {
  ...
  getDeterministicImportedNames() {
    ...
    if (parent1 instanceof MemberExpression2) {
      ...
      if (callExpression2.arguments.length !== 1 || !(thenCallback instanceof ArrowFunctionExpression2 || thenCallback instanceof FunctionExpression)) {
        return;
      }
...
async function watchInternal(configs, emitter) {
  ...
  await loadFsEvents();
  const { Watcher } = await import("./watch-PDX6EHPJ.js");
...
rollup/dist/es/shared/node-entry.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-ZMR7QZAO.js.map
